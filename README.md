...
**Documentation**:
<br><br>[Recommended PowerShell modules to use](https://docs.microsoft.com/en-us/powershell/microsoftgraph/tutorial-entitlement-management?view=graph-powershell-1.0)
<br><br>
***Contact***:
